...
3. Adjust the canvas size: **Image** > **Canvas Size**. Because the 1620x1024px image is taller than the optimal 1280x640px GitHub size, we first adjust the canvas size. We have to add some width. So here adjust the width to 2048px [`1024 * 2` or `1024 * (1280 / 640)`] and keep the height at 1032px.
